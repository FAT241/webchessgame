    ...
    return (
        <div className="auth-container">
            <div className="auth-box">
                ...
                {message && <div className="alert-msg" style={{color: message.startsWith('✅') ? 'green' : '#ffeb3b'}}>{message}</div>}
                <form onSubmit={onSubmit}>
                    ...
                    {isRegister && (
                        <div className="form-group">
                            ...
                            <input type="password" name="confirmPassword" value={confirmPassword} onChange={onChange} required placeholder="Xác nhận..." />
                        </div>
                    )}
